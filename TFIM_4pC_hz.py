...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec 14 18:41:02 2021
...
def TFIM_O1_chaos_parameter(N, B, J, x, z, time_lim):
...
for i,z in enumerate(zs):
    [O1s_H, O2s_H, Cs_H], [O1s_U, O2s_U, Cs_U], r_normed_H, r_normed_U = TFIM_O1_chaos_parameter(N, B, J, x, z, time_lim)
...
for i,z in enumerate(zs):
    ...
    ax[0].plot(times, yaxis_H,':^r' , label=f'ang={z:.1f}', color=colors[i], ms=0.5);
    ...
    ax[1].plot(times, yaxis_U,':^b' , label=f'ang={z:.1f}', color=colors[i], ms=0.5);
